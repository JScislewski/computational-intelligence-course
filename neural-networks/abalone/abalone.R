...
abalone=read.csv("H:\\Projects\\computational-intelligence-course\\neural-networks\\abalone\\abalone.csv")
set.seed(8000)
...
setpoints<-target(abalone$rings)

network<-newff(n.neurons=c(8,10,28),
...
y<-sim(results$net,abalone[idxTest,])
